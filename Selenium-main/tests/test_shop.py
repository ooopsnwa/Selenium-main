...
@pytest.mark.xfail(reason="Wait for fix bug 'Распродажа товаров некликабельна'") 
...
def test_right_way(browser):
    ...
    common_helper.enter_input(input_id="billing_first_name", data="Sergey")
    common_helper.enter_input(input_id="billing_last_name", data="Smirnov")
    common_helper.enter_input(input_id="billing_address_1", data="1, Nevsky pr.")
    common_helper.enter_input(input_id="billing_city", data="Saint-Petersburg")
    common_helper.enter_input(input_id="billing_state", data="Saint-Petersburg")
    common_helper.enter_input(input_id="billing_postcode", data="197372")
    common_helper.enter_input(input_id="billing_phone", data="+79817090000")
    common_helper.enter_input(input_id="billing_email", data="pismoss@mail.ru")
